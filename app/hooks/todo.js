...
export function useTodo() {
    ...
    useEffect(() => {
  // Fetch  a userprofile if there is a profile then gets its accounts
         ...
         if(program && publicKey && !transactionPending){
            try {
                ...
                if(profileAccount){
                    ...
                    const todoAccounts = await program.account.todoAccount.all(authorFilter(program, publicKey));
